...
def central_pirates(pirate):
    ...
    if pirate.getPosition() == (dimension_x // 2, dimension_y // 2):
        if pirate.getSignal() == "":
            pirate.setSignal("top-left")
        elif pirate.getSignal() == "centre":
            pirate.setSignal("top-left")
        elif pirate.getSignal() == "top-left":
            pirate.setSignal("middle-top")
        elif pirate.getSignal() == "middle-top":
            pirate.setSignal("top-right")
        elif pirate.getSignal() == "top-right":
            pirate.setSignal("middle-right")
        elif pirate.getSignal() == "middle-right":
            pirate.setSignal("bottom-right")
        elif pirate.getSignal() == "bottom-right":
            pirate.setSignal("middle-bottom")
        elif pirate.getSignal() == "middle-bottom":
            pirate.setSignal("bottom-left")
    ...
    if pirate.getSignal() == "centre":
        ...
        return moveTo(dimension_x // 2, 0, pirate)
    elif pirate.getSignal() == "middle-right":
        return moveTo(dimension_x - 1, dimension_y // 2, pirate)
    elif pirate.getSignal() == "middle-bottom":
        return moveTo(dimension_x // 2, dimension_y - 1, pirate)
    else:  # Handle any unexpected signal
        return random.randint(1, 4)
